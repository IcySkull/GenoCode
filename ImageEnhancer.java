...
public class ImageEnhancer extends Component implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    // Also add code to enable and disable the Undo and Redo menu items, and to
    // process
  ...
  public void run() {
    JFrame f = new JFrame("ImageEnhancer With Undo or Redo by Geno"); // Students should update this.
